...
export const mainPageSEO = {
    title: "Free Kanban Board - Visual Task Management Tool | Drag & Drop Project Board",
    description: "Free online Kanban board for visual task management. Organize projects with drag & drop functionality, track progress across To Do, In Progress, Review, and Done columns. Built with TypeScript and modern web technologies.",
    keywords: "kanban board, task management, project management, agile, scrum, visual workflow, drag and drop, productivity tool, project tracker, team collaboration, typescript kanban, free kanban board",
    url: baseConfig.baseUrl + "/",
    ogTitle: "Free Kanban Board - Visual Task Management Tool",
    ogDescription: "Organize your projects visually with our free Kanban board. Drag & drop tasks, track progress, and boost productivity with this modern task management tool.",
    twitterTitle: "Free Kanban Board - Visual Task Management Tool",
    twitterDescription: "Organize your projects visually with our free Kanban board. Drag & drop tasks, track progress, and boost productivity.",
};
// Project details page SEO configuration
export const projectDetailsSEO = {
    title: "Kanban Board Project Details - TypeScript Task Management System",
    description: "Detailed overview of our TypeScript Kanban board project. Learn about features, technical specifications, and architecture of this modern task management system with drag & drop functionality.",
    keywords: "kanban board project, typescript kanban, task management system, project details, agile board, scrum tool, drag drop kanban, web development project, javascript kanban",
    url: baseConfig.baseUrl + "/project-details.html",
    ogTitle: "Kanban Board Project Details - TypeScript Task Management",
    ogDescription: "Explore the technical details and features of our modern Kanban board built with TypeScript. Complete project overview and specifications.",
    twitterTitle: "Kanban Board Project Details",
    twitterDescription: "Technical overview of our TypeScript Kanban board project with modern features and architecture.",
};
...
export function injectSEOMetaTags(config) {
