import { TaskStatus, TaskPriority, Task } from "../types.js";
import {
  moveTask,
  addTask,
  updateTask,
...
function getStatusFromColumn(columnName: string): TaskStatus {
...
function getColumnFromStatus(status: TaskStatus): string {
...
// --- Setup drag and drop listeners ---
function setupDragAndDropListeners(): void {
...
// --- Setup task editing listeners ---
function setupTaskEditingListeners(): void {
...
function populateTaskForm(task: Task): void {
  const titleInput = document.getElementById("task-title") as HTMLInputElement;
